...
public class FragmentSignUpBindingImpl extends FragmentSignUpBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.edt_account_sign, 1);
        sViewsWithIds.put(R.id.edt_password_sign, 2);
        sViewsWithIds.put(R.id.btn_sign_up, 3);
        sViewsWithIds.put(R.id.btn_cancel, 4);
        sViewsWithIds.put(R.id.ll_progress_fragment_sign_up, 5);
    }
    // views
    @NonNull
    ...
    private FragmentSignUpBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            , (com.trang.ez_mobile.util.custormView.ButtonFont) bindings[4]
            , (com.trang.ez_mobile.util.custormView.ButtonFont) bindings[3]
            , (com.trang.ez_mobile.util.custormView.EditTextFont) bindings[1]
