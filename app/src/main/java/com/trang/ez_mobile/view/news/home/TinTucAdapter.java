...
public class TinTucAdapter extends RecyclerView.Adapter<TinTucAdapter.MyViewHolder> {
    private List<TinTuc> newList;
    private Context context;
    private String folder;
    TinTucInterface.View v;

    public TinTucAdapter(List<TinTuc> newList, Context context, String folder, TinTucInterface.View v) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                v.moveFragmentView(newList.get(position).getStringId(), newList.get(position).getStringImg(), folder);
            }
        });
    }
