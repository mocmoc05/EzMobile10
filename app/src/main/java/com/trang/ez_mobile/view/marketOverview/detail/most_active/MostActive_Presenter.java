...
import static com.trang.ez_mobile.util.Define.SHARED_PREFERENCES_MARKETOVERVIEW_DATAMARKET_DETAIL_MOST_ACTIVE;
...
public class MostActive_Presenter {
    ...
    public MostActive_Presenter(IDetail_View.IDetailPrice_View view, String marketName, int type) {
        Log.w("MostActive_Presenter", "MostActive_Presenter: " + marketName + "  " + type);
        this.view = view;
    ...
    private void LoadData() {
        ...
        isRequesting = true;
        _parameter.put("s", "top_realtime");
        _parameter.put("c", category);
        _parameter.put("type", type);
        Log.w("MostActive_Presenter", "LoadData: " + category + " " + type);
...
//type: 1,2,3,4,5,6; trong đó 1: Price up; 2: price down; 3: quantity up; 4: quantity down; 5: value up; 6: value down
                    ...
                    editor.putString(SHARED_PREFERENCES_MARKETOVERVIEW_DATAMARKET_DETAIL_MOST_ACTIVE, s);
    ...
    private void getDataFromSharedPreferences(int category) {
        ...
        String str = preferences.getString(SHARED_PREFERENCES_MARKETOVERVIEW_DATAMARKET_DETAIL_MOST_ACTIVE, "");
