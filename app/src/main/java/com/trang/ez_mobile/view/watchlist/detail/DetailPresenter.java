...
public class DetailPresenter {
    ...
    public DetailPresenter(IDetailView iDetailView, String symbol) {
    ...
    private void LoadData() {
        ...
        final List<Stock> data = new ArrayList<>();
        api.getString("quotes2", symbol).subscribeOn(io()).map(s -> s)
