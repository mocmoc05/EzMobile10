...
import static com.trang.ez_mobile.util.Define.SHARED_PREFERENCES_MARKETOVERVIEW_DATAMARKET_DETAIL_TOP_GAINERS;
...
public class TopGainers_Presenter {
    ...
    public TopGainers_Presenter(IDetail_View.IDetailPrice_View  view, String marketName, int type) {
        Log.w("TopGainers_Presenter", "TopGainers_Presenter: ");
        this.view = view;
...
//type: 1,2,3,4,5,6; trong đó 1: Price up; 2: price down; 3: quantity up; 4: quantity down; 5: value up; 6: value down
                    editor.putString(SHARED_PREFERENCES_MARKETOVERVIEW_DATAMARKET_DETAIL_TOP_GAINERS, s);
    ...
    private void getDataFromSharedPreferences(int category) {
        ...
        String str = preferences.getString(SHARED_PREFERENCES_MARKETOVERVIEW_DATAMARKET_DETAIL_TOP_GAINERS, "");
