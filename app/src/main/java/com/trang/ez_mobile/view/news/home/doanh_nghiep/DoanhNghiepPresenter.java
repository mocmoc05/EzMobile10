package com.trang.ez_mobile.view.news.home.doanh_nghiep;
...
public class DoanhNghiepPresenter implements TinTucInterface.Presenter {
    ...
    private String keyShered = "Tin_Doanh_Nghiep";


    public DoanhNghiepPresenter(Context context, TinTucInterface.View view, List<TinTuc> tinTucList) {
    ...
    public void getData() {
        if (Utils.isNetworkAvailable() == true) {
            ...
            Call<String> stringCall = myService.getStringTinTuc("news2", "1", "86", "abt", "1", "20");
                ...
                public void onResponse(Call<String> call, Response<String> response) {
                    if (response.isSuccessful()) {
                        ...
                        if (responseString.equals("")) {
                            ...
                            view.getDataDone(tinTucList, "86");
