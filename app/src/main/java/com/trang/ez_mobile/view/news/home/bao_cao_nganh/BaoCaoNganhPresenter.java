package com.trang.ez_mobile.view.news.home.bao_cao_nganh;
...
public class BaoCaoNganhPresenter implements TinTucInterface.Presenter {
    ...
    private String keyShered = "Tin_Bao_Cao_Nganh";

    public BaoCaoNganhPresenter(Context context, TinTucInterface.View view, List<TinTuc> tinTucList) {
    ...
    public void getData() {
        if (Utils.isNetworkAvailable() == true) {
            ...
            Call<String> stringCall = myService.getStringTinTuc("news2", "1", "212", "abt", "1", "20");
                ...
                public void onResponse(Call<String> call, Response<String> response) {
                    if (response.isSuccessful()) {
                        ...
                        if (responseString.equals("")) {
                            ...
                            view.getDataDone(tinTucList, "212");
