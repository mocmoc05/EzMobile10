package com.trang.ez_mobile.view.news.home.phan_tich_binh_luan;
...
public class PhanTichBinhLuanPresenter implements TinTucInterface.Presenter {
    ...
    private String keyShered = "Tin_PhanTich_BinhLuan";

    public PhanTichBinhLuanPresenter(Context context, TinTucInterface.View view, List<TinTuc> tinTucList) {
    ...
    public void getData() {
        if (Utils.isNetworkAvailable() == true) {
            ...
            Call<String> stringCall = myService.getStringTinTuc("news2", "1", "12", "abt", "1", "20");
                ...
                public void onResponse(Call<String> call, Response<String> response) {
                    if (response.isSuccessful()) {
                        ...
                        if (responseString.equals("")) {
                            ...
                            view.getDataDone(tinTucList, "12");
