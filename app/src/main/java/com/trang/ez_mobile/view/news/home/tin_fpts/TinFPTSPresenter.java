...
public class TinFPTSPresenter implements TinTucInterface.Presenter {
    ...
    private String keyShered = "Tin_FPTS";

    public TinFPTSPresenter(Context context, TinTucInterface.View view, List<TinTuc> tinTucList) {
    ...
    public void getData() {
        if (Utils.isNetworkAvailable()== true) {
            ...
            Call<String> stringCall = myService.getStringTinTuc("news2", "1", "173", "abt", "1", "20");
                ...
                public void onResponse(Call<String> call, Response<String> response) {
                    if (response.isSuccessful()) {
                        ...
                        if (responseString.equals("")) {
                            ...
                            view.getDataDone(tinTucList, "173");
