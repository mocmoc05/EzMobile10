...
public class PhanTichBinhLuanFragment extends Fragment implements TinTucInterface.View {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        presenter = new PhanTichBinhLuanPresenter(App.getInstance(), this, tinTucList);
        presenter.getData();
